...
$selectdetail ="SELECT domain_details.*, address.*
FROM domain_details
INNER JOIN address
ON domain_details.domain_id=address.domain_id WHERE domain_details.domain_id=$domain_id";
...
{						 
	$row=mysqli_fetch_assoc($result);
	   ...
	   echo"<div class='form-row'>
		<div class='field-label'><label for='DomainStatus'>* 1b. (N)ew or (M)odify or (D)elete.(N/M/D).:</label><span class='field-widget2'> ". $row['domstatus'] ." </span></div>";
	   ...
	   echo"<div class='form-row'>
		<div class='field-label' ><label for='OrganisationNmae'>* 2b. Organisation Name.....:</label><span class='field-widget2'> ". $row['domain_owner_org_name'] ." </span></div>";
	   ...
	   echo"<div class='form-row'>
		<div class='field-label'><label for='TownCity'>* 2e. Town/City.............:</label><span class='field-widget2'> ". $row['city'] ." </span></div>";

	   echo"<div class='form-row'>
		<div class='field-label'><label for='Country'>* 2f. Country...............:</label><span class='field-widget'> ". $row['country_id'] ." </span></div>";

	   echo"<div class='form-row'>
		<div class='field-label'><label for='Mobile_Work_Phone '>* 2g. Voice Phone...........:</label><span class='field-widget2'> ". $row['EmailAddress2'] ." </span></div>";

	   echo"<div class='form-row'>
		<div class='field-label'><label for='FaxNumber'>2h. Fax Number............:</label><span class='field-widget'> ". $row['CountryBased'] ." </span></div>";
		
			   echo"<div class='form-row'>
		<div class='field-label'><label for='EmailAddress'>* 2i. E-mail Address........:</label><span class='field-widget'> ". $row['EmailAddress1'] ." </span></div>";


echo "3.  ADMIN/BILLING CONTACT";
	   echo"<div class='form-row'>
		<div class='field-label'><label for='BillingZispaHandle'>* 3a. ZISPA Handle..........:</label><span class='field-widget'> ". $row['EmailAddress1'] ." </span></div>";

	   echo"<div class='form-row'>
		<div class='field-label'><label for='BillingContactName'>* 3b. Contact Name..........:</label><span class='field-widget'> ". $row['EmailAddress1'] ." </span></div>";
	   ...
	   echo"<div class='form-row'>
		<div class='field-label'><label for='BillingTownCity'>* 3f. Town/City.............:</label><span class='field-widget'> ". $row['EmailAddress1'] ." </span></div>";

	   echo"<div class='form-row'>
		<div class='field-label'><label for='BillingCountry'>* 3g. Country...............:</label><span class='field-widget'> ". $row['name'] ." </span></div>";

	   echo"<div class='form-row'>
		<div class='field-label'><label for='BillingMobileWorkPhone'>* 3h. Voice Phone...........:</label><span class='field-widget'> ". $row['EmailAddress1'] ." </span></div>";

	 echo"<div class='form-row'>
	<div class='field-label'><label for='BillingFaxNumber'>3i. Fax Number............:</label><span class='field-widget'> ". $row['EmailAddress1'] ." </span></div>";

	 echo"<div class='form-row'>
	<div class='field-label'><label for='BillingEmailAddress'>* 3j. E-mail Address........:</label><span class='field-widget'> ". $row['EmailAddress1'] ." </span></div>";
	...
	<div class='field-label'><label for='OrganisationDescription'>* 4a. Description of domain owner's organisation..:</label><span class='field-widget'> ". $row['domain_owner_org_desc'] ." </span></div>";
      ...
      echo "5.  TECHNICAL CONTACT";
	   ...
	   echo"<div class='form-row'>
		<div class='field-label'><label for='TechZispaHandle'>* 5a. ZISPA Handle..........:</label><span class='field-widget'> ". $row['EmailAddress1'] ." </span></div>";

	   echo"<div class='form-row'>
		<div class='field-label'><label for='TechContactName'>* 5b. Contact Name..........:</label><span class='field-widget'> ". $row['EmailAddress1'] ." </span></div>";

	   echo"<div class='form-row'>
		<div class='field-label'><label for='TechOrganisationName'>* 5c. Organisation Name.....:</label><span class='field-widget'> ". $row['EmailAddress1'] ." </span></div>";

	   echo"<div class='form-row'>
		<div class='field-label'><label for='TechPhysicalAddress'>* 5d. Physical Address .....:</label><span class='field-widget'> ". $row['EmailAddress1'] ." </span></div>";

	   echo"<div class='form-row'>
		<div class='field-label'><label for='TechPostalAddress'>* 5e. Postal Address .......:</label><span class='field-widget'> ". $row['EmailAddress1'] ." </span></div>";

	   echo"<div class='form-row'>
		<div class='field-label'><label for='TechTownCity'>* 5f. Town/City.............:</label><span class='field-widget'> ". $row['name'] ." </span></div>";
