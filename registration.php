...
<div class="header">LTZ ZISPA Domain Registration Form</div>
...
<form method="post" action="process.php" id="regform">
    ...
    <fieldset>
        ...
        <div id="jttip-0" class="jttip" style="display:none;">
            <div class="jttipcontent"><p>e.g liquid.co.zw</p></div>
        </div>
        ...
        <div id="jttip-5" class="jttip" style="display:none;">
            <div class="jttipcontent"><p>e.g Liquid Telecom Zimbabwe , Museyamwa & Assoc e.t.c</p></div>
        </div>
        </p>
        <p>
        ...
        <table border="0">
            <tr>
                ...
                <td><label for="hostname">Host Name:</label> <input type="text" name="primary_ns_hostname"
                                                                    value="ns1.liquidtelecom.com"/></td>
                <td><label for="ip address">IP Address:</label> <input type="text" name="primary_ns_ipaddress"
                                                                       value="5.11.11.1"/>
                </td>
            </tr>
            <tr>
                <td><label for="secondarynameserver">Secondary Nameserver:</label></td>
                <td><label for="hostname">Host Name:</label> <input type="text" name="secondary_ns_hostname"
                                                                    value="ns2.liquidtelecom.com"/></td>
                <td><label for="ip address">IP Address:</label> <input type="text" name="secondary_ns_ipaddress"
                                                                       value="5.11.11.10"/>
                </td>
            </tr>
        </table>
...
<div class='footer'>Courtesy of the Zimbabwe IS Team LTZ @2017 <a href='#'>ltz</a></div>
</body>
</html>                                		